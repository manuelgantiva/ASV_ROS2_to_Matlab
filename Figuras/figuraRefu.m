function figuraRefu(ref_llc, obs, obs_liu, obs_zono, obs_zono_min,obs_zono_max, angvel_data,linvel_data, directorio_destino)
...
plot(obs_zono.tiempo,obs_zono.u_hat, 'Color', '#D95319', 'LineWidth', 0.5);
...
leg1 = legend('$u_{ref}$','$\widehat{u}_{K_n=10}$','$\widehat{u}_{K_n=1}$','$u_{apm}$','$\widehat{r}_{Zono}$');
...
plot(obs_zono.tiempo,obs_zono.v_hat, 'Color', '#D95319', 'LineWidth', 0.5);
...
leg1 = legend('$\widehat{v}_{K_n=10}$','$\widehat{v}_{K_n=1}$','$v_{apm}$','$\widehat{r}_{Zono}$');
set(leg1,'Interpreter','latex');
set(leg1,'FontSize',10);
...
plot(obs_zono.tiempo,obs_zono.r_hat, 'Color', '#D95319', 'LineWidth', 0.5);
...
leg1 = legend('$r_{ref}$','$\widehat{r}_{K_n=10}$','$\widehat{r}_{K_n=1}$','$r_{apm}$','$\widehat{r}_{Zono}$');
set(leg1,'Interpreter','latex');
set(leg1,'FontSize',10);

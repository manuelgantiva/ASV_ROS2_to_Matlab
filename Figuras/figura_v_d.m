function figura_v_d(angvel_data, linvel_data, obs_guille, obs_zono, obs_zono_min,obs_zono_max, directorio_destino)
fig = figure('Name', 'Velocities and disturbances', 'NumberTitle', 'off');
subplot(3,2,5);
plot(angvel_data.tiempo,angvel_data.r_imu, 'b', 'LineWidth', 1.5);
hold on
plot(obs_guille.tiempo,obs_guille.r_hat, 'r', 'LineWidth', 1.5);
...
leg1 = legend('$r_{m}$','Bejarano et al.','Orihuela el al.');
...
%%
subplot(3,2,1);
plot(linvel_data.tiempo,linvel_data.u_imu, 'b', 'LineWidth', 1.5);
hold on
plot(obs_guille.tiempo,obs_guille.u_hat, 'r', 'LineWidth', 1.5);
...
leg1 = legend('Measured $u$','Bejarano et al.','Orihuela el al.');
set(leg1,'Interpreter','latex');
set(leg1,'FontSize',10);
title('Estimation of $u$','Interpreter','latex','FontSize',15)
%%
subplot(3,2,3);
plot(linvel_data.tiempo,linvel_data.v_imu, 'b', 'LineWidth', 1.5);
hold on
plot(obs_guille.tiempo,obs_guille.v_hat, 'r', 'LineWidth', 1.5);
...
leg1 = legend('Measured $v$','Bejarano et al.','Orihuela el al.');
set(leg1,'Interpreter','latex');
set(leg1,'FontSize',10);
...
plot(obs_zono_min.tiempo,obs_zono_min.su_hat, '--g', 'LineWidth', 1.0);
plot(obs_zono_max.tiempo,obs_zono_max.su_hat, '--g', 'LineWidth', 1.0);
xlim([0 inf]);
grid on
hold off
xlabel('Time $(s)$','Interpreter','latex','FontSize',12);
ylabel('$\sigma_u~(m~s^{-2})$','Interpreter','latex','FontSize',12);
leg1 = legend('Bejarano et al.','Orihuela el al.');
set(leg1,'Interpreter','latex');
set(leg1,'FontSize',10);
...
plot(obs_zono_min.tiempo,obs_zono_min.sv_hat, '--g', 'LineWidth', 1.0);
plot(obs_zono_max.tiempo,obs_zono_max.sv_hat, '--g', 'LineWidth', 1.0);
xlim([0 inf]);
grid on
hold off
xlabel('Time $(s)$','Interpreter','latex','FontSize',12);
...
plot(obs_zono_min.tiempo,obs_zono_min.sr_hat, '--g', 'LineWidth', 1.0);
plot(obs_zono_max.tiempo,obs_zono_max.sr_hat, '--g', 'LineWidth', 1.0);
xlim([0 inf]);
grid on
hold off
xlabel('Time $(s)$','Interpreter','latex','FontSize',12);
